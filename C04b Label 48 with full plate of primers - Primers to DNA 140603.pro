...
<Velocity11 file='Protocol_Data' md5sum='f23be46ae717c23e64d4250119ac36b4' version='2.0' >
		...
		<Main_Processes >
			<Process >
				...
				<Task Name='Bravo::SubProcess' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Sub-process name' Value='Bravo SubProcess 5' />
					...
					<Parameters >
						<Parameter Centrifuge='0' Name='SubProcess_Name' Pipettor='1' Value='Bravo SubProcess 5' />
					</Parameters>
				</Task>
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='DNA' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Primers' />
					<Parameter Name='Plate type' Value='Guys 96 Eppendorf PP Rnd Well Cone Btm PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='Bravo SubProcess 5' >
				<Minimized >0</Minimized>
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						...
						<Parameter Category='' Name='Body' Value='Add DNA to Primers

1: Tip rack - half full of clean tips in columns 1-3 &amp; 7-9
3: Tip rack - empty, for used tips
4: DNA plate (spun down)
5: Full primers plate (spun down)' />
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;f89f3464827a7684646a6414ba7583f3&apos; version=&apos;1.0&apos; &gt;
	&lt;PipetteHeadMode Channels=&apos;0&apos; ColumnCount=&apos;12&apos; RowCount=&apos;8&apos; SubsetConfig=&apos;0&apos; SubsetType=&apos;0&apos; /&gt;
&lt;/Velocity11&gt;' />
					</Parameters>
...
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;6697b897711f0caa9d9cf7e857bcd94f&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Primers' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						...
						<Parameter Category='Properties' Name='Well selection' Value='&lt;?xml version=&apos;1.0&apos; encoding=&apos;ASCII&apos; ?&gt;
&lt;Velocity11 file=&apos;MetaData&apos; md5sum=&apos;1ac4b9203d0ab042916b9916a7a1bcb6&apos; version=&apos;1.0&apos; &gt;
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DNA' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Mix [Dual Height]' Task_Type='4096' >
					...
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DNA' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
						<Parameter Category='Volume' Name='Volume' Value='32' />
						<Parameter Category='Volume' Name='Pre-aspirate volume' Value='' />
						<Parameter Category='Volume' Name='Blowout volume' Value='10' />
						<Parameter Category='Properties' Name='Liquid class' Value='Guys QC Water 50-100ul' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='615' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Don&apos;t be a dummy' />
						<Parameter Category='' Name='Body' Value='Take plate from position 4
Cap with strip caps using tool to go over them in 2 directions
Short spin (15s at max speed), then onto PCR machine

Cover primer plate with foil seal, write half plate on the top, and place back in labelling kit box to be stored at -20C
