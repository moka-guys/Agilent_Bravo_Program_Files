...
<Velocity11 file='Protocol_Data' md5sum='82e3b52c060e9e5dc0c3701feca17788' version='2.0' >
	...
	<Processes >
		...
		<Main_Processes >
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='Polymerase enzyme' />
			...
			<Process >
				...
				<Plate_Parameters >
					<Parameter Name='Plate name' Value='DNA &amp; Primers' />
					<Parameter Name='Plate type' Value='Guys 96 Eppendorf PP Rnd Well Cone Btm PCR' />
					<Parameter Name='Simultaneous plates' Value='1' />
					<Parameter Name='Plates have lids' Value='0' />
					<Parameter Name='Plates enter the system sealed' Value='0' />
			...
			<Pipette_Process Name='Bravo SubProcess 5' >
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Has_Breakpoint >0</Has_Breakpoint>
					<Advanced_Settings >
						<Setting Name='Estimated time' Value='1384' />
					</Advanced_Settings>
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Title' Value='Don&apos;t be a dummy' />
						<Parameter Category='' Name='Body' Value='Add Polymerase enzyme to DNA &amp; primers

1: Tip rack - full of clean tips
3: Tip rack - empty
4: Polymerase enzyme plate (yellow sticker; spun down)
6: DNA &amp; Primers plate (spun down)' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Aspirate' Task_Type='1' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='Polymerase enzyme' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='Bravo::secondary::Dispense' Task_Type='2' >
					...
					<TaskScript Name='TaskScript' Value='' />
					<Parameters >
						<Parameter Category='' Name='Location, plate' Value='DNA &amp; Primers' />
						<Parameter Category='' Name='Location, location' Value='&lt;auto-select&gt;' />
...
&lt;/Velocity11&gt;' />
				...
				<Task Name='BuiltIn::User Message' >
					...
					<Parameters >
						<Parameter Category='' Name='Title' Value='Don&apos;t be a dummy' />
						<Parameter Category='' Name='Body' Value='Take plate from position 6
Seal plate using a clear seal
Quick spin
Place back into in PCR machine (onto 37C overnight)
' />
						<Parameter Category='' Name='Only show the first time' Value='' />
						<Parameter Category='Scripting variable data entry' Name='User data entry into variable' Value='' />
						<Parameter Category='Scripting variable data entry' Name='Variable name' Value='' />
